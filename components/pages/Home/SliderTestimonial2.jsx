...
const SliderTestimonial = () => {
  ...
  return (
    <section id="slider_testimonials2">
            ...
            <div className="slider__slider" data-autoplay="true">
              <Slider {...settings} ref={slider1}>
                <div className="slider__item">
                  <div>
                    <img src="img/testimonial/testimonial-img-1.jpg" />
                    <blockquote className="slider__item-content">
                      Our experience with Ivan Santacruz was nothing short of
                      excellent from start to finish. His knowledge of real
                      estate and the homes in our area/neighborhood, as well ...
                    </blockquote>
                  </div>
                ...
                <div className="slider__item">
                  <div>
                    <img src="img/testimonial/testimonial-img-2.jpg" />
                    <blockquote className="slider__item-content">
                      Ivan was fantastic to work with! He was able to sell our
                      home the first weekend with 11 offers and sold our house
                      for 10% more than what we listed it for.
                    </blockquote>
                  </div>
                ...
                <div className="slider__item">
                  <div>
                    <img src="img/testimonial/testimonial-img-3.jpg" />
                    <blockquote className="slider__item-content">
                ...
                <div className="slider__item">
                  <div>
                    <img src="img/testimonial/testimonial-img-4.jpg" />
                    <blockquote className="slider__item-content">
                      Ivan helped us with an investment property recently. He
                      was very responsive and always on top of all the details.
                      He is definitely an expert you can trust.
                    </blockquote>
                  </div>
                ...
                <div className="slider__item">
                  <div>
                    <img src="img/testimonial/testimonial-img-5.jpg" />
                    <blockquote className="slider__item-content">
